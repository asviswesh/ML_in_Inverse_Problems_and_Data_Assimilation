...
plt.title("RK45 Solver, Fully Observed, Noise Level = 0.5", fontsize=16)
plt.xlabel("Index", fontsize=14)
plt.ylabel("Values", fontsize=14)

# Annotate the diff value on the plot
...
plt.tight_layout()
plt.savefig("problem1_noisy.pdf", dpi=300)
